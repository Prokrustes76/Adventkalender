class Door {
  ...
  static hasVideo = [3, 4, 7, 11, 16, 17, 18, 21, 22, 23]
  static done = [1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 14, 15, 16, 17, 18, 21, 22, 23]
  static noContent = [6, 12, 13, 19, 20, 23, 24]
  ...
  open() {
    ...
    if (Door.hasVideo.includes(this.id)) {
      let url = this.id ==  3 ? 'https://www.youtube-nocookie.com/embed/WCfIiaaYtKA?modestbranding=1' :
                ...
                this.id == 18 ? 'https://www.youtube-nocookie.com/embed/yJa9mCt6Np0?modestbranding=1' : 
                this.id == 21 ? 'https://www.youtube-nocookie.com/embed/ORthzIOEf30?modestbranding=1' :
                this.id == 22 ? 'https://www.youtube-nocookie.com/embed/4zOZWctrZf8?modestbranding=1' :
                this.id == 23 ? 'https://www.youtube-nocookie.com/embed/pZwNzQhjcHE?modestbranding=1' : undefined
