class Door {
  ...
  static hasVideo = [3, 4, 7, 11, 16, 17, 18, 21, 22]
  static done = [1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 14, 15, 16, 17, 18, 21, 22]
  ...
  open() {
    ...
    if (Door.hasVideo.includes(this.id)) {
      let url = this.id ==  3 ? 'https://www.youtube-nocookie.com/embed/WCfIiaaYtKA?modestbranding=1' :
                ...
                this.id == 22 ? 'https://www.youtube-nocookie.com/embed/4zOZWctrZf8?modestbranding=1' : undefined
